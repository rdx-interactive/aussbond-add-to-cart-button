...
Show the add-to-cart button only for logged-in users.

= 1.0.25 =

Forced WooCommerce View cart links generated on Aussbond add-to-cart pages to use the cart page instead of the checkout redirect URL.

= 1.0.24 =

Added a visible View cart link to the success popup, pointed it to the cart page instead of checkout, and added Elementor popup/link style controls.
